export class SoundManager {
        ...
        try {
            switch (type) {
                case 'click':
                    ...
                    gain.gain.exponentialRampToValueAtTime(0.01 * this.sfxVolume, t + 0.1);
                    osc.start(t);
                    osc.stop(t + 0.1);
                    break;
                ...
                case 'error':
                    ...
                    gain.gain.linearRampToValueAtTime(0.01 * this.sfxVolume, t + 0.3);
                    osc.start(t);
                    osc.stop(t + 0.3);
                    break;
                ...
                case 'synthesize':
                    ...
                    gain.gain.setValueAtTime(0.1 * this.sfxVolume, t);
                    gain.gain.exponentialRampToValueAtTime(0.01 * this.sfxVolume, t + 0.5);
                    osc.start(t);
                    osc.stop(t + 0.5);
                ...
                case 'attack':
                    ...
                    gain.gain.exponentialRampToValueAtTime(0.01 * this.sfxVolume, t + 0.2);
                    osc.start(t);
                    osc.stop(t + 0.2);
                    break;
            }
    ...
    private playTone(freq: number, type: 'sine' | 'square' | 'triangle', dur: number, startTime?: number) {
        ...
        gain.gain.setValueAtTime(0.1 * this.sfxVolume, t);
        gain.gain.exponentialRampToValueAtTime(0.01 * this.sfxVolume, t + dur);
        osc.connect(gain);
        gain.connect(this.ctx.destination);
        osc.start(t);
        osc.stop(t + dur);
